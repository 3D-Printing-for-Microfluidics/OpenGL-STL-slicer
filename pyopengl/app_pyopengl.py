...
def prepareSlice():
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, printer.width, printer.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, None)
...
def renderSlice(shader, height, filename):
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_STENCIL, printer.width, printer.height)
    ...
    data = glReadPixels(0, 0, printer.width, printer.height, GL_RED, GL_UNSIGNED_BYTE)
